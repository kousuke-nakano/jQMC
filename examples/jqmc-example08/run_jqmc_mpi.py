...
if rank == 0:
    ...
    logger.setLevel(logging.ERROR)  # Suppress logs from other ranks
...
# All ranks read TREXIO (it's read-only)
...
mcmc_opt = MCMC(
    ...
    Dt=0.01,
    mcmc_seed=42,
    num_walkers=500,  # This is walkers per MPI process
...
# get_E performs MPI reduction internally
