...
optimizer_kwargs = { delta = 0.050, epsilon = 0.001 } # SR step size and diagonal regularization used for numerical stability.
opt_J1_param = true
opt_J2_param = true
opt_J3_param = true
...
optimizer = "sr" # Use stochastic reconfiguration (i.e., the natural gradient) optimizer.
optimizer_kwargs = { delta = 0.05, epsilon = 0.001 } # SR step size and diagonal regularization used for numerical stability.
opt_J1_param = true
opt_J2_param = true
opt_J3_param = true
